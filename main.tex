...
Otra relación para calcular el flujo de calor intercambiado utiliza la capacidad térmica específica de los fluidos $c_p$, el caudal másico $\dot{m}$ y la diferencia de temperatura entre la salida y la entrada $T_{1A}-T_{1E}$
\begin{equation}
